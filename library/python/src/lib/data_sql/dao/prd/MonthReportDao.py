class MonthReportDao:
    ...
    def get_upsert_query(self):
        return """
                MERGE month_report AS TARGET
                USING month_report_temp AS SOURCE
                ...
                WHEN MATCHED THEN
                    UPDATE SET
                        ...
                        TARGET.nr_unattributed_new_subs = SOURCE.nr_unattributed_new_subs,
                        ...
                        TARGET.nr_active_subscriptions_next_month = SOURCE.nr_active_subscriptions_next_month,
                        TARGET.active_subscription_churn_rate = SOURCE.active_subscription_churn_rate,
                        TARGET.nr_paid_subscriptions = SOURCE.nr_paid_subscriptions,
                        TARGET.nr_paid_subscriptions_next_month = SOURCE.nr_paid_subscriptions_next_month,
                        TARGET.paid_subscription_churn_rate = SOURCE.paid_subscription_churn_rate,
                ...
                VALUES (
                    ...
                    SOURCE.nr_unattributed_new_subs,
                    SOURCE.nr_paid_customers,
                    SOURCE.nr_paid_customers_subscriptions,
                    SOURCE.nr_active_customers,
                    SOURCE.nr_active_subscriptions,
                    SOURCE.nr_active_subscriptions_next_month,
                    SOURCE.active_subscription_churn_rate,
                    SOURCE.nr_paid_subscriptions,
                    SOURCE.nr_paid_subscriptions_next_month,
                    SOURCE.paid_subscription_churn_rate,                    
                    SOURCE.nr_payments,
