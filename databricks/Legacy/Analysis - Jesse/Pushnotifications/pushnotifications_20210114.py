...
query = "SELECT * FROM userbase_pushnotifications_20210114;"
...
"""
timezone_dict = {'NFN GB': 0, 'NFN IE':0, 'NFN SE':1, 'NFN NO':1, 'NFN NL':1, 'NFN AU':10,'NFN NZ':10,'WL NL': 1}
...
for channel in channel_list:
  ...
  query_videostarts = """
  tracking 
  | where userId in {} and action == 'Start'
  | summarize video_id_count = dcount(videoId) by bin(timestamp + {}h,1d), userId;
  """.format(userid_tuple,timezone_dict[channel])
...
date_list = [
             pd.Timestamp('2021-1-1T00', tz='UTC'),pd.Timestamp('2021-1-2T00', tz='UTC'),pd.Timestamp('2021-1-3T00', tz='UTC')
            ,pd.Timestamp('2021-1-4T00', tz='UTC'),pd.Timestamp('2021-1-5T00', tz='UTC'),pd.Timestamp('2021-1-6T00', tz='UTC')
            ,pd.Timestamp('2021-1-7T00', tz='UTC'),pd.Timestamp('2021-1-8T00', tz='UTC'),pd.Timestamp('2021-1-9T00', tz='UTC')
            ,pd.Timestamp('2021-1-10T00', tz='UTC'),pd.Timestamp('2021-1-11T00', tz='UTC'),pd.Timestamp('2021-1-12T00', tz='UTC')
            ,pd.Timestamp('2021-1-13T00', tz='UTC'),pd.Timestamp('2021-1-14T00', tz='UTC'),pd.Timestamp('2021-1-15T00', tz='UTC')
            ,pd.Timestamp('2021-1-16T00', tz='UTC'),pd.Timestamp('2021-1-17T00', tz='UTC'),pd.Timestamp('2021-1-18T00', tz='UTC')
            ]
...
date_list = [pd.Timestamp('2021-1-9T00', tz='UTC'),pd.Timestamp('2021-1-10T00', tz='UTC'),pd.Timestamp('2021-1-11T00', tz='UTC')]
...
for channel in channel_list:
  ...
  query_watchtime = """
  tracking
  | where userId in {} and videoPlayTime > 0
...
date_list = [pd.Timestamp('2021-1-14T00', tz='UTC'), pd.Timestamp('2021-1-15T00', tz='UTC'), pd.Timestamp('2021-1-16T00', tz='UTC')]
