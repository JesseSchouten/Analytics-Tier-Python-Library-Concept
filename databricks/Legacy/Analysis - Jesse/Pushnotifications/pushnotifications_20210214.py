...
load_list_from_json("/dbfs/FileStore/tables/20210210/WL/BE/control_group.json")

control_group_paths = ["/dbfs/FileStore/tables/20210210/WL/BE/control_group.json","/dbfs/FileStore/tables/20210210/WL/NL/control_group.json","/dbfs/FileStore/tables/20210210/WL/NO/control_group.json","/dbfs/FileStore/tables/20210210/WL/SE/control_group.json"]
group_1_paths = ["/dbfs/FileStore/tables/20210210/WL/BE/experimental_group_1.json","/dbfs/FileStore/tables/20210210/WL/NL/experimental_group_1.json","/dbfs/FileStore/tables/20210210/WL/NO/experimental_group_1.json","/dbfs/FileStore/tables/20210210/WL/SE/experimental_group_1.json"]
group_2_paths = ["/dbfs/FileStore/tables/20210210/WL/BE/experimental_group_2.json","/dbfs/FileStore/tables/20210210/WL/NL/experimental_group_2.json","/dbfs/FileStore/tables/20210210/WL/NO/experimental_group_2.json","/dbfs/FileStore/tables/20210210/WL/SE/experimental_group_2.json"]

control_group =[]
group_1 = []
group_2 = []
for control_group_path,group_1_path,group_2_path in zip(control_group_paths, group_1_paths,group_2_paths):
    control_group += load_list_from_json(control_group_path)
    group_1 +=load_list_from_json(group_1_path)
    group_2 += load_list_from_json(group_2_path)
...
date_list = []
d = pd.Timestamp('2021-2-14T00', tz='UTC')
for i in range(1,3):
  date_list.append(d)
...
plt.title('Videostarts between 14 - 16 jan . per group - WL NL')
plt.legend()
