...
control_group_paths = ["/dbfs/FileStore/tables/20210227/NFN/NL/control_group.json"]
group_1_paths = ["/dbfs/FileStore/tables/20210227/NFN/NL/experimental_group_NFN_NL_theencounter.json"]
...
date_list = []
d = pd.Timestamp('2021-2-26T00', tz='UTC')
for i in range(1,4):
  date_list.append(d)
...
date_list = []
d = pd.Timestamp('2021-1-14T00', tz='UTC')
for i in range(1,50):
