...
selected_viewing_df = viewing_df_nfnau.copy()
user_id_list = user_id_nfnau
...
current_date = datetime(2021,5,25,0,0,0)
past_days = 20
print("Control group:")
control_group_df = add_column_avg_viewing_time_past_x_weeks(selected_viewing_df_2[selected_viewing_df_2['group']=='control_group'],current_date,past_days=past_days)
display(control_group_df)
print("Experimental group:")
exp_group_df = add_column_avg_viewing_time_past_x_weeks(selected_viewing_df_2[selected_viewing_df_2['group']=='experimental_group'],current_date,past_days=past_days)
